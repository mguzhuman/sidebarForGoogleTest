...
*/    var aa = __webpack_require__(0), n = __webpack_require__(1), r = __webpack_require__(5);
    function u(a) {
        for (var b = "https://reactjs.org/docs/error-decoder.html?invariant=" + a, c = 1; c < arguments.length; c++) b += "&args[]=" + encodeURIComponent(arguments[c]);
        return "Minified React error #" + a + "; visit " + b + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
    }
...
/***/ function(module, __webpack_exports__, __webpack_require__) {
    ...
    var react = __webpack_require__(0), react_default =  __webpack_require__.n(react), react_dom = __webpack_require__(2), textBlock = function(_a) {
        var text = _a.text, type = _a.type;
        return react_default.a.createElement("div", null, react_default.a.createElement("h3", null, "Type: ", type), react_default.a.createElement("h3", null, "Text: ", text));
    }, slideDataBox = function() {
        var _a = Object(react.useState)(""), type = _a[0], setType = _a[1], _b = Object(react.useState)(""), text = _b[0], setText = _b[1];
        return Object(react.useEffect)((function() {
            var intervalID = window.setInterval((function() {
                google.script.run.withSuccessHandler((function(data) {
                    setType(data.type), setText(data.text);
            ...
            className: "sidebar"
        }, react_default.a.createElement(textBlock, {
            text: text,
            type: type
        }));
    };
    // CONCATENATED MODULE: ./src/client/index.tsx
     __webpack_require__.n(react_dom).a.render(react_default.a.createElement(slideDataBox, null), document.getElementById("index"));
}
/******/ ]);